...
export interface ApiFinancialSanpFinancialSanp
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::financial-sanp.financial-sanp'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.DynamicZone<['shared.card']>;
...
export interface ApiHomeHome extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cards: Schema.Attribute.Component<'shared.card-home', true> &
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer: Schema.Attribute.Component<'shared.footer-home', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
